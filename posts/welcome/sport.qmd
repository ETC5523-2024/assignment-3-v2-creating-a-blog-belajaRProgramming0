...
```{r}
#| label: fig-veddriq
#| fig-cap: Men's Speed Climbing Gold Medalist of Olympics 2024, Veddriq Leonardo at _Le Bourget_ Climbing Venue, Paris, France, (8/8/2024). [ANTARA FOTO/Wahyu Putro A]

library(knitr)
knitr::include_graphics("images/veddriq.png") #tambahin option biar penuh layar
